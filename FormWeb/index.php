...
<div class="links-btn">
        <a class="fcc-btn" href="/index.php">Inicio</a>
                 ...
                 <div class="row">
                   <div class="col">
                    <select name="deficiencia" id="">
                        <option value="BaixaVisão">Baixa visão</option>
                        <option value="Cegueira">Cegueira</option>
                        <option value="DeficiêciaAuditiva">Deficiêcia auditiva</option>
                        <option value="DeficiêciaFísica" >Deficiêcia física</option>
                        <option value="DeficiêciaIntelectual" >Deficiêcia intelectual</option>
                        <option value="Surdez" >Surdez</option>
                        <option value="Surdocegueira" >Surdocegueira</option>
                        <option value="DeficiêciaMúltipla" >Deficiêcia múltipla</option>
                        <option value="TranstornoDeEspectroAutista" >Transtorno de espectro autista</option>
                        <option value="Nenhuma" >Nenhuma</option>
                        <option value="Deficiências" selected>Deficiências</option>
                    </select>
                   </div> 
                   <div class="col">
                    <select name="concorrencia" id="">
              
                        <option value="EscolaPública">Escola pública</option>
                        <option value="EscolaPrivada">Escola privada</option>
                        <option value="Concorrência" selected>Concorrência</option>
                      </select>
                   </div>
                  </div>
