function mascaraTel() {
  ...
  if (valorInput.length === tamanhoInput) {
      document.getElementById('telefoneInput').value = mascara.telefone;
  }
}

function mascaraTel2() {
  const tamanhoInput = document.getElementById('telefoneInput2').maxLength;
  let valorInput = document.getElementById('telefoneInput2').value;
  ...
  if (valorInput.length === tamanhoInput) {
      document.getElementById('telefoneInput2').value = mascara.telefone;
  }
}
